  var contentString = [];
   ...
   contentString[0] = '<div id="pop-up">'+
      ...
      '</div>'+
      '<img src=http://depts.washington.edu/depress/images/hoovervilles/Hooverville_June10-1937_Lee399.jpg>'+
      '</div>';
   ...
   contentString[1] = '<div id="pop-up">'+
	...
	contentString[2] = '<div id="pop-up">'+
      ...
      '<div id="bodyContent">'+
      '<p>' +
      'The idea for building a large domed stadium in Seattle first surfaced in 1959. After Seattle was granted a MLB franchise in 1967 (the Pilots), King County voters approved bonds in 1968 that would pay for such a facility. While the Pilots ultimately relocated to Milwaukee after just one season, Seattle subsequently received an NFL franchise in 1974 (the Seahawks, to begin playing in 1976) and a replacement MLB franchise in 1976 (the Mariners). Completed in 1976, the Kingdome would serve as the home of both franchises until its demolition in 2000. Financially, the stadium was a failure. By the 1990s, the owners of both the Mariners and Seahawks believed the revenue it generated inadequate; the bonds initially authorized to pay for the stadium in 1968 are still being paid off in 2015. Further, the stadium suffered structural problems, including a partial roof collapse in 1994. That said, many Seattle sports fans remember the venue with nostalgia. The Kingdome could be very loud and difficult to play in for visiting teams, its atmosphere served as the origin for the famed Seahawks “12th man.” Once derided as an eyesore, its ugliness has now become a piece of nostalgic 1970s kitsch in the eyes of many.</p>' +
      '</div>'+
    ...
    contentString[12] = '<div id="pop-up">'+
      ...
      '<div id="bodyContent">'+
      '<p>' +
      'Discovery Park is located at the site of what was once Ft. Lawton, which had served as US Army Base between 1900 and 1970. The city of Seattle purchased the land after it was surplused by the federal government in 1971. Discovery Park was officially established in 1973. However, its creation was highly controversial. Regional Native American groups were angered city officials ignored their requests to open a cultural center on the surplussed land. Led by Bernie Whitebear (of the Colville Confederate tribe in eastern Washingotn), the Native groups argued that 19th century treaties granted surplus military lands to its original owners. As a result, the United Indians of All Tribes (UIAT)—some of whose members had been involved in a similar, more famous occupation of San Francisco’s Alcatraz Island in 1969—occupied the now-decommissioned For Lawton for three months in 1970. Their action led to the creation of Daybreak Star Cultural Center in 1971, which still operates today. The events around the Discovery Park’s creation are interesting for the key role in the Native American civil rights or “Red Power” movement. Discovery Park’s creation is also an example of Seattle’s transition away from the military-industrial economy that had been so central to the city’s (and the Puget Sound region’s) growth for most of the 20th century.</p>'+
      '</div>'+
