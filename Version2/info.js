  var contentString = [];
   ...
   contentString[1] = '<div id="pop-up">'+
	  ...
	  '<div id="bodyContent">'+
	  '<p>' +
	  'When white settlers originally arrived in Seattle during the 1850s, a ridge of hills separated Elliot Bay from Lake Washington. The hills defining this ridge began their ascent at the water’s edge, making travel and building on the site very difficult. During the next 60 years, much of this ridge was flattened, the excess dirt used to create Seattle’s waterfront. For example, today’s Western Avenue and Alaskan Way sit on land that was once part of Elliot Bay. The picture below depicts the Denny Regrade, the last and most ambitious regarding project the city undertook. The regrade targeted Denny Hill, which once covered the neighborhood of Belltown. Its architects originally hoped the regarded land would become lucrative real estate, but the Great Depression damaged these dreams. The area instead became a low-rent district until the 1990s, when Seattle’s technology boom gentrified almost overnight what had been a district of vacant lots, seedy bars, and pay-by-the-hour hotels.</p>'+
	  '</div>'+
    ...
    contentString[6] = '<div id="pop-up">'+
      ...
      '<div id="bodyContent">'+
      '<p>' +
      'In 1909, Japanese immigrants Sanzo and Matsuyo Murakami opened the Higo 10 Cent Store. The store was located on Weller Street in Nihonmichi, or “Japantown,” a bustling neighborhood of 8,500 that served as the hub of Japanese immigrant life in Seattle. The Higo 10 Cent Store provided a range of Japanese household goods for the Japanese immigrant community, but also attracted an increasingly white customer base intrigued by the store’s “exoticism.” The store proved so popular that it moved to the two-story Jackson Building, where it eventually occupied nine storefronts between 602 and 608 South Jackson Street. Like other Japanese-Americans, the Murakamis were forcibly relocated to an internment camp in 1942 as a result of Executive Order 9066. However, unlike many other Japanese-American business owners, the Murakamis were able to re-open their business when World War II ended. The (now) Higo Variety Store would remain open until 2003, when Masa Murakami (Sanzo and Matsuyo’s daughter) chose to close the business. However, the Higo storefront remains and the location today houses Kobo, a Japanese-inspired art gallery and craft store. Below is a photograph the store as it appeared in 1943, boarded up after the Murkakamis had been interned.</p>'+
      '</div>'+
    ...
    contentString[11] = '<div id="pop-up">'+
      ...
      '</div>'+
      '<img id="big-img" src=http://amazongenius.com/wp-content/uploads/2012/08/amazon2.jpg>'+
      '</div>';
