  var contentString = [];
   ...
   contentString[1] = '<div id="pop-up">'+
    ...
    contentString[9] = '<div id="pop-up">'+
      ...
      '<div id="bodyContent">'+
      '<p>' +
      'The piers at Smith Cove (today, the Port of Seattle\'s Terminal 91) has been central to Seattle\'s economic development since the late 19th century. Initially, the area was the site for the terminus for James. J Hill\'s Great Northern Railway. The Japanese Company Nippon Yusen Kaisha (NYK) used several piers at the site as the terminus for the first regular steamship service between the Asia and the Pacific Coast of North America. For much of the 20th century, the Smith Cover piers were dominated by the United States Navy. In particular, the site was the location of an important 253-acre naval supply depot during World War II as well as the Korean and Vietnam Wars. Smith Cove\'s intertwined history of military provisioning and international trade came together during the Vietnam War era. The United States Armed Services became convinced that shipping military equipment in standardized 20 foot and 40 foot containers was highly efficient. However, the shipping lines charged with supplying the military equipment did not like carrying paying cargo on only the western Pacific crossing. As a result, companies like Matson and Sea-Land would stop in Japan on their way back from Vietnam to pick up manufactured goods produced by the booming Japanese economy. While the Smith Cove piers would ultimately be used more for oil trans-shipment and fishing than for containerized cargo, their role in as staging ground for container shipping during the Vietnam War was an important founding moment in the globalization of the American economy.</p>'+
      '</div>'+
      '</div>';
